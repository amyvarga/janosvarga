<!--
	...
	Heritage Homes on the West Island Gallery page
...
$result = mysqli_query($db, "SELECT titlePage, metaDescription, header_1, imageLocation FROM settings WHERE pageName='heritage'") or die("SQL error: ".mysql_error());
$myrow = mysqli_fetch_array($result);
$header_1 = $myrow["header_1"];	//name of gallery on gallery pages
$galleryName = "heritage";	//for side navigation on gallery pages
$pageName = "heritage";		//for top navigation

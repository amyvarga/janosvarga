...
$result = mysqli_query($db, "SELECT titlePage, metaDescription, header_1, imageLocation FROM settings WHERE pageName='worldwide'") or die("SQL error: ".mysql_error());
$myrow = mysqli_fetch_array($result);
$header_1 = $myrow["header_1"];	//name of gallery on gallery pages
$galleryName = "worldwide";	//for side navigation on gallery pages
$pageName = "worldwide";		//for top navigation

...
<!-- Start of pageContainrt --> 	
	...
	<!-- Start of Welcome Text --> 		
		<div id="welcomtext">
			<h1>Admin For Edit</h1>
		</div><!-- end of Welcome Text -->
					
		<div id="editSection">
			<div id="" class="firstSelect"> 
			<form action="editAdmin.php" method="POST" id="editForm" name="editForm" onSubmit="return validateForm();">
				<label for="page">User name</label>
				<select id = "page" name='editUser' style="width:200px">			
				<?php
					$result=mysql_query("SELECT id,user from userlist") or die(mysql_error());          
            ...
            <hr/>
            <a href="addAdmin.php"><button id="new" name = "new" value = "new" class="upper edits btn" >ADD NEW</button></a>
		</div>

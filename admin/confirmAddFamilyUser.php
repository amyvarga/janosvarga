...
<!-- Start of pageContainrt --> 	
	...
	<!-- Start of Welcome Text --> 		
		<div id="welcomtext">
			<h1>Addition New Family User</h1>
...
<?php	
	...
	if ((empty($newUser)) or (empty($newPass))) {
			...
			$result=mysql_query("INSERT INTO familylist (name,psw,email)  values ('$newUser','$newPass','$newEmail')") or die(mysql_error());          

...
$result = mysql_query("SELECT * FROM family WHERE namePage='index'",$db) or die("SQL error: ".mysql_error());
$myrow = mysql_fetch_array($result);
$pageName = "familyindex";	//for top and  footer navigation (do not show navigation to self-page) 
?>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <title>Family Varga</title>
  <!-- Meta Description for Search Engine Results -->
  <meta name="description" content="Family Varga">
...
<!-- Start of pageContainrt --> 	
	...
	<!-- Start of Welcome Text --> 		
        ...
        <?php   if($myrow["namePicture1"]!=""){ 
          			print('<img src="../images/'); echo $myrow["namePicture1"]; print('" width="100%" alt="Picture">');
				}
		?>
